# Text mining project: Analysis of Amazon product reviews using NLP and Text Mining techniques
...
*   Topic modeling and identification using Non-negative Matrix Factorization (NMF)